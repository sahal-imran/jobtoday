                    ...
                    <Box sx={{ width: '100%', display: "flex", justifyContent: 'space-between', alignItems: 'center', }} >
                        <Box sx={{ display: "flex", justifyContent: 'center', alignItems: 'start', flexDirection: 'column' }} >
                            <Typography variant='h2' sx={{ fontSize: '28px', lineHeight: '36px', fontFamily: 'GraphikSemiBold', color: '#29293d' }} >
                                Popular job locations for Pakistan
                            </Typography>
                            <Typography variant='h2' sx={{ fontSize: '18px', lineHeight: '22px', fontFamily: 'GraphikRegular', color: '#29293d', mt: 1 }} >
                                ...
                                Cities.map((city) => {
                                    return <Grid key={city.id} item xs={6} md={3}>
                                        <Box sx={{ width: '100%', display: "flex", justifyContent: 'start', alignItems: 'center' }} >
                                            <AnchorLink href='' sx={{ fontSize: '18px', lineHeight: '22px', fontFamily: 'GraphikRegular', color: '#29293d', textDecoration: 'none', textTransform: 'capitalize' }} >
                                                {city.city}
                                            </AnchorLink>
                                        </Box>
                                    </Grid>
